...
object Dependencies {
  lazy val acolyte = "org.eu.acolyte" %% "jdbc-scala" % "1.0.53"

  lazy val acolytePlay = "org.eu.acolyte" %% "play-jdbc" % "1.0.53"
  ...
  lazy val postgres = "org.postgresql" % "postgresql" % "42.2.9"
